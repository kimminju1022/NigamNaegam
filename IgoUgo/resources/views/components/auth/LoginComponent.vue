<template>
    <div class="form-box">
        ...
        <div class="login-form">
            ...
            <input v-model="userInfo.user_email" @keyup.enter="goLogin" class="input-login" type="email" placeholder="e-mail" name="user_email">
            <input v-model="userInfo.user_password" @keyup.enter="goLogin" class="input-login" type="password" placeholder="password" name="user_password">
        </div>
        <div class="login-btn">
