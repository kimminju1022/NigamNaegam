                ...
                <div v-show="boardInfo.boardDetail.bc_type === '0'" class="board-review-box">
                    ...
                    <div class="board-starGrade board-category">
                        ...
                        <div class="star-grade">
                            <input type="radio" name="rate" id="star-1" class="star" value="1" v-model="boardInfo.boardDetail.rate">
                            <label for="star-1" class="star-label"></label>
            
                            <input type="radio" name="rate" id="star-2" class="star" value="2" v-model="boardInfo.boardDetail.rate">
                            ...
                            <input type="radio" name="rate" id="star-4" class="star" value="4" v-model="boardInfo.boardDetail.rate">
                            <label for="star-4" class="star-label"></label>
            
                            <input type="radio" name="rate" id="star-5" class="star" value="5" v-model="boardInfo.boardDetail.rate">
